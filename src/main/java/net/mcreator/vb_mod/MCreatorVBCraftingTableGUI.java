...
public class MCreatorVBCraftingTableGUI extends Elementsvb_mod.ModElement {
	...
	public static class GuiContainerMod extends Container {
		...
		public GuiContainerMod(World world, int x, int y, int z, EntityPlayer player) {
			...
			if (ent instanceof MCreatorVBCraftingTable.TileEntityCustom)
		...
		private void slotChanged(int slotid, int ctype, int meta) {
			if (this.world != null && this.world.isRemote) {
				vb_mod.PACKET_HANDLER.sendToServer(new GUISlotChangedMessage(slotid, x, y, z, ctype, meta));
	...
	public static class GuiWindow extends GuiContainer {
		...
		private static final ResourceLocation texture = new ResourceLocation("vb_mod:textures/vbcraftingtablegui.png");
		...
		protected void drawGuiContainerForegroundLayer(int par1, int par2) {
			this.fontRenderer.drawString("VB Crafting Table", 3, 4, -13421773);
		}
		...
		protected void actionPerformed(GuiButton button) {
			vb_mod.PACKET_HANDLER.sendToServer(new GUIButtonPressedMessage(button.id, x, y, z));
