...
public class MCreatorIladioLand extends Elementsvb_mod.ModElement {
	public static int DIMID = 3;
	public static final boolean NETHER_TYPE = false;
	@GameRegistry.ObjectHolder("vb_mod:iladioland")
	public static final Item block = null;
	public static DimensionType dtype;

	public MCreatorIladioLand(Elementsvb_mod instance) {
		super(instance, 32);
	}
	...
	public void preInit(FMLPreInitializationEvent event) {
		if (DimensionManager.isDimensionRegistered(DIMID)) {
			...
			System.err.println("Dimension ID for dimension iladioland is already registered. Falling back to ID: " + DIMID);
		}
		dtype = DimensionType.register("iladioland", "_iladioland", DIMID, WorldProviderMod.class, true);
	...
	public static class ChunkProviderModded implements IChunkGenerator {
		private static final IBlockState STONE = Blocks.EMERALD_BLOCK.getDefaultState();
		private static final IBlockState STONE2 = MCreatorIladiolandFloor.block.getDefaultState();
	...
	public static class GenLayerBiomesCustom extends GenLayer {
		private Biome[] allowedBiomes = {Biome.REGISTRY.getObject(new ResourceLocation("void")),
				Biome.REGISTRY.getObject(new ResourceLocation("jungle")),};
